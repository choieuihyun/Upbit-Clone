...
class CoinInfoCoinTrendHighestIncreaseRateAdapter :
    ListAdapter<CoinInfoCoinTrendHighestIncreaseRateModel, CoinInfoCoinTrendHighestIncreaseRateViewHolder>(
        diffCallback
    ) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): CoinInfoCoinTrendHighestIncreaseRateViewHolder {

        return CoinInfoCoinTrendHighestIncreaseRateViewHolder(
            FragmentCoinInfoCointrendHighestIncreaseRateListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false), coinTickersMap)

    }

    override fun onBindViewHolder(
        holder: CoinInfoCoinTrendHighestIncreaseRateViewHolder,
        position: Int
    ) {

        val highestIncreaseRate = currentList[position]
        holder.bind(highestIncreaseRate)
    ...
    companion object {
        ...
        private val diffCallback =
            object : DiffUtil.ItemCallback<CoinInfoCoinTrendHighestIncreaseRateModel>() {

                override fun areItemsTheSame(
                    oldItem: CoinInfoCoinTrendHighestIncreaseRateModel,
                    newItem: CoinInfoCoinTrendHighestIncreaseRateModel
                ): Boolean {
